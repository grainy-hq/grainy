...
fetchJson<{ contacts: Contact[] }>("/api/friends/contacts").then((d) =>
...
alt=""
                ...
                <div className="flex size-9 items-center justify-center rounded-full bg-gradient-to-br from-accent/30 to-accent-secondary/20 text-xs font-semibold text-accent">
                  {c.name[0]}
                </div>
              )}
