...
href: "/plus",
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-border bg-card/90 px-2 pb-2 pt-1 backdrop-blur-xl lg:hidden">
      {items.map((item) => {
