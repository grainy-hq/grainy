...
return (
    <div className="group rounded-2xl border border-border bg-gradient-to-br from-accent/5 to-accent-secondary/5 p-5 backdrop-blur">
...
className="flex size-10 items-center justify-center rounded-full bg-black/60 text-white backdrop-blur transition hover:bg-black/80"
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 h-1 w-full overflow-hidden rounded-full bg-white/10">
            <div
              className="h-full rounded-full bg-gradient-to-r from-accent to-accent-secondary transition-all duration-150"
