/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: a980b6b8f216d551404435e98fb3b946)
// Runtime types generated with workerd@1.20260611.1 2026-06-14 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  DRIZZLE_PROXY: Fetcher
  IMAGES: ImagesBinding
  ASSETS: Fetcher
  DISCORD_CLIENT_ID: string
  DISCORD_CLIENT_SECRET: string
  DRIZZLE_PROXY_URL: string
  DRIZZLE_PROXY_TOKEN: string
  DRIZZLE_PROXY_DATABASE: string
  DATABASE_URL: string
